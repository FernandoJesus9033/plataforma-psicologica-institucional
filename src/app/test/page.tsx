...
export default function TestPage() {
  ...
  const styles = {
    ...
    downloadLink: { display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.6rem 1.2rem', background: '#4f46e5', color: 'white', borderRadius: '30px', textDecoration: 'none', marginBottom: '1rem', fontWeight: '500' },
