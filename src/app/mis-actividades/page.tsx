...
import { FaDownload, FaCalendarAlt, FaClock, FaCheckCircle, FaHourglassHalf } from "react-icons/fa";
...
export default function MisActividadesPage() {
  ...
  const styles = {
    ...
    fileLink: { display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.75rem', color: '#4f46e5', textDecoration: 'none', background: '#eef2ff', padding: '0.25rem 0.75rem', borderRadius: '30px' },
              ...
              <div key={act.id} style={styles.card} onClick={() => handleCardClick(act.id)}>
                ...
                {act.fileUrl && (
                  <button 
                    ...
                    style={{ ...styles.fileLink, background: 'none', border: 'none', cursor: 'pointer' }}
                  >
